...
# Usage: irm https://install.muxi.ai/windows.ps1 | iex
# Or:    Invoke-RestMethod -Uri https://install.muxi.ai/windows.ps1 | Invoke-Expression
...
USAGE:
    ...
    Or with options:
    irm https://install.muxi.ai/windows.ps1 | iex -Version v0.20251024.0 -AddToPath
...
EXAMPLES:
    ...
    irm https://install.muxi.ai/windows.ps1 | iex -Version v0.20251024.0
    
    # Install and add to PATH
    irm https://install.muxi.ai/windows.ps1 | iex -AddToPath
